...
class Gazebo_Linefollow_Env(gazebo_env.GazeboEnv):
    ...
    def process_image(self, data):
        ...
        x = np.where(img[height-15, :]==255)[0]
        ...
        # Compute position of line relative to center of image
        if (cX>0):
            # Compute which segment of the image the line is in
            segment_size = cv_image.shape[1] // 10
            segment_index = int(cX// segment_size)
